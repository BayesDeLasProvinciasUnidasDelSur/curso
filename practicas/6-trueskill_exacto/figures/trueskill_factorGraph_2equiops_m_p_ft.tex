...
\node[det, fill=black!20] (r) {$r_1$};
	...
	\edge[-] {fd} {tb};
        ...
        \path (p1) edge[bend left, arrow, color=red] node [right] {} (fta);
        \path (p2) edge[bend right, arrow, color=red] node [right] {} (fta);	      
        \path (p3) edge[bend right, arrow, color=red] node [left] {} (ftb);
        \path (p4) edge[bend left, arrow, color=red] node [left] {} (ftb);
\end{tikzpicture}
