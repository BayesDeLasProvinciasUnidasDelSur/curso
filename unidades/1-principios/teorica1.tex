...
\begin{frame}[plain]
 ...
 \Large \onslide<4->{Principio de indiferencia }
\end{textblock}
\vspace{1.5cm}
\centering
...
\Large Detrás de una caja hay un regalo.
\end{textblock}
}
...
Acuerdo intersubjetivo \\ \large Máximiza incertidumbre dada información disponible
\end{textblock}
}
...
\begin{textblock}{160}(0,62)
\begin{equation*}
\ \phantom{P(r|s=2,\text{M}) =} \hfrac{P(r, s=2|\text{M})}{\phantom{P(s_2|\text{M})}}
\end{equation*}
\end{textblock}
}
...
\begin{textblock}{160}(0,62)
\begin{equation*}
\ \phantom{P(r|s=2,\text{M}) =}\hfrac{P(r, s=2|\text{M})}{P(s_2|\text{M})}
\end{equation*}
\end{textblock}
}
...
\begin{textblock}{160}(0,62)
\begin{equation*}
P(r|s=2,\text{M}) = \frac{P(r, s=2|\text{M})}{P(s_2|\text{M})}
\end{equation*}
\end{textblock}
}
