...
axis(lwd=0,side=1, at=s_1,labels=expression(mu[i]),las=0,cex.axis=1.5,line=-0.75)
axis(lwd=0,side=2, at=s_2,labels=expression(mu[j]),las=0,cex.axis=1.5,line=-0.75)
