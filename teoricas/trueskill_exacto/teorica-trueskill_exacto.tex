...
\Wider[2cm]{
\begin{align*}
P(\text{Resultado}| \text{Modelo}) & = 1 - \Phi\Big(0 \, | \, \underbrace{(\mu_1 + \mu_2) - (\mu_3 + \mu_4)}_{\text{\normalsize Diferencia esperada: $\delta$}} \, , \, \underbrace{4\beta^2 + \sigma_1^2  + \sigma_2^2  + \sigma_3^2  + \sigma_4^2}_{\text{\normalsize incertidumbre total: $\vartheta^2$}}\Big)
\end{align*}
}
