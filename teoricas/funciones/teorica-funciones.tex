...
\pause
 ...
 \begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
      \includegraphics[width=\textwidth]{../../auxiliar/static/funcionMatematica.png}
...
\begin{frame}[plain]
 \begin{textblock}{160}(0,4)
 \centering \LARGE
  \includegraphics[width=0.35\textwidth]{../../auxiliar/static/game_of_life.png}
\end{textblock}
...
\tikz{     
    \onslide<1->{
    \node[const] (a) {\includegraphics[width=0.2\textwidth]{../../auxiliar/static/game_of_life-forma_fijo.png}};
    \node[const, left=of a,xshift=-0.3cm] (na) {Fijo:};
    }
    
    \onslide<2->{
    \node[const, below=of a] (b) {\includegraphics[width=0.2\textwidth]{../../auxiliar/static/game_of_life-forma_periodico.png}}; 
    \node[const, left=of b,xshift=-0.3cm] (nb) {Periódico:};
    }
    
    \onslide<3->{
    \node[const, below=of b] (c) {\includegraphics[width=0.2\textwidth]{../../auxiliar/static/game_of_life-forma_caminante.png}};
    \node[const, left=of c,xshift=-0.3cm] (nc) {Periódico caminante:};
    }
    
    \onslide<4->{
    \node[const, below=of c] (d) {\includegraphics[width=0.2\textwidth]{../../auxiliar/static/game_of_life-forma_periodico_creciente.png}}; 
...
\includegraphics[width=0.48\textwidth]{../../auxiliar/static/game_of_life-not_0.png}
\includegraphics[width=0.48\textwidth]{../../auxiliar/static/game_of_life-not_1.png}
...
\includegraphics[width=0.32\textwidth]{../../auxiliar/static/game_of_life-and_01.png}
\includegraphics[width=0.32\textwidth]{../../auxiliar/static/game_of_life-and_10.png}
\includegraphics[width=0.32\textwidth]{../../auxiliar/static/game_of_life-and_11.png}
\end{textblock}
...
\vspace{1cm}
  ...
  \centering
\includegraphics[width=0.6\textwidth]{../../auxiliar/static/game_of_life-latch.png}
...
\includegraphics[width=0.45\textwidth]{../../auxiliar/static/game_of_life-life_in_life.png}
\onslide<2>{
\includegraphics[width=0.45\textwidth]{../../auxiliar/static/game_of_life-galaxy.png}
}
\end{frame}
...
\only<2->{
\begin{textblock}{160}(32,48)
$\hfrac{\text{\normalsize Indicadores}}{\text{\normalsize Evidencia empírica}}$  \Bigg\{
\end{textblock}
}

\only<2->{
\begin{textblock}{160}(92.5,40.5)
$\Big\} \hfrac{\text{\normalsize Modelos causales}}{\text{\normalsize Evidencia teórica}}$
\end{textblock}
}
...
\vspace{1.2cm}
 ...
 \centering
Un concepto es T-teórico si todo \emph{procedimiento de determinación} presupone la teoría T, y es T-no teórico si existe alguno que no la presupoga.
...
\includegraphics[page=2,width=0.45\textwidth]{figuras/baseEmpirica.pdf}
