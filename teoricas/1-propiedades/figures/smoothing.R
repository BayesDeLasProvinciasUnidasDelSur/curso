...
axis(side=1, labels=NA,cex.axis=0.6,tck=0.015, line=-2.2)
axis(lwd=0,side=1, at=0,cex.axis=5,line=-0.5,tck=0.015)
lines(s,dnorm(s, data$lh_a_1_mu[1], data$lh_a_1_sigma[1]), lwd=7,col=rgb(0.6,0.25,0.25)) 
for (i in seq(2,n-1)){
...
axis(side=1, labels=NA,cex.axis=0.6,tck=0.015, line=-2.2)
axis(lwd=0,side=1, at=0,cex.axis=5,line=-0.5,tck=0.015)
lines(s,dnorm(s, data$lh_a_2_mu[1], data$lh_a_2_sigma[1]), lwd=7,col=rgb(0.6,0.25,0.25)) 
for (i in seq(2,n-1)){
...
axis(side=1, labels=NA,cex.axis=0.6,tck=0.015, line=-2.2)
axis(lwd=0,side=1, at=0,cex.axis=5,line=-0.5,tck=0.015)
lines(s,dnorm(s, data$lh_b_1_mu[1], data$lh_b_1_sigma[1]), lwd=7,col=rgb(0.6,0.25,0.25 )) 
for (i in seq(2,n-1)){
...
axis(side=1, labels=NA,cex.axis=0.6,tck=0.015, line=-2.2)
axis(lwd=0,side=1, at=0,cex.axis=5,line=-0.5,tck=0.015)
lines(s,dnorm(s, data$lh_b_2_mu[1], data$lh_b_2_sigma[1]), lwd=7,col=rgb(0.6,0.25,0.25 )) 
for (i in seq(2,n-1)){
