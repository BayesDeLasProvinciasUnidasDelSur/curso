...
\tikz{ %
        ...
        \onslide<5->{\path[draw, ->, fill=black!50] (fr) edge[bend left,draw=black!50] node[left,color=black!75] {\only<6->{$1$}} (t);}
...
\begin{flalign*}
  P(t,e^*) & = P(e^*) P(t) \\
  \onslide<11->{P(t|e^*) &= \frac{P(e^*) P(t) }{P(e^*)}} \onslide<12->{= P(t)}&&
\end{flalign*}
\end{textblock}
}
...
\begin{textblock}{160}(0,4)
 \centering \Large
 $P(l|a) \only<-7>{\overset{?}{=}}\only<8>{\overset{\phantom{?}}{=}} P(l|a,e)$
\end{textblock}
...
\tikz{ %
        ...
        \node[factor] (fa) {} ;
        \node[det, fill=black!10, below=of fa, minimum size=0.55cm, yshift=0.6cm] (a) {$a$} ; %
        
        \node[factor, below=of a, yshift=0.6cm] (fl) {} ;
        \node[det, below=of fl, minimum size=0.55cm,yshift=0.6cm] (l) {$l$} ; %
        
        \node[det, fill=black!10, above=of fa, minimum size=0.55cm, xshift=-0.8cm, yshift=-0.6cm] (e) {$e$} ; %
        \node[factor, above=of e, yshift=-0.6cm] (fe) {} ;
        
        \node[det,minimum size=0.55cm, above=of fa, xshift=0.8cm, yshift=-0.6cm] (t) {$t$} ; %
        \node[factor, above=of t, yshift=-0.6cm] (ft) {} ;
        \node[factor, below=of t, xshift=0.8cm, yshift=0.6cm] (fr) {} ;
        \node[det,minimum size=0.55cm, below=of fr, yshift=0.6cm] (r) {$r$} ; %
...
\begin{textblock}{100}(60,20)
 $m_{f_e\rightarrow e}\phantom{(e)} = P(e^*) $  \\[0.1cm]
 $m_{f_t\rightarrow t}(t) = P(t)$  \\[0.1cm]
 %$m_{f_r\rightarrow t}(t) = \sum_r \, P(r|t) = 1$  \\
 %$m_{f_l\rightarrow a}(a) = \sum_l \, P(l|a) = 1 $  \\
 %$m_{f_a\rightarrow t}(t) = \onslide<2->{\sum_{t} \, P(e^*) P(a|e^*,t)} \onslide<3->{= P(e^*)}$  \\
 %$m_{f_a\rightarrow e}\phantom{(e)} = \sum_{ta} \, P(t) P(a|e^*,t) = 1$  \\
 %$m_{f_r\rightarrow r}(r) = \onslide<4->{\sum_{t} \, P(t) P(r|t)} \onslide<5->{= P(r,e^*)}$ \\
 $ \onslide<2->{m_{f_a\rightarrow a}\phantom{(a)} = \sum_{t} \, P(e^*)P(t)P(a^*|e^*,t)}\onslide<3->{  = P(a^*,e^*)}$  \\[0.1cm]
 $\onslide<4->{m_{f_l\rightarrow l}(l) = P(a^*,e^*) P(l|a^*)}
 \onslide<5->{ = P(l,a^*,e^*)}$
 \end{textblock}
...
\only<6->{
\begin{textblock}{80}(65,55)
\begin{flalign*}
  \, P(l|a^*,e^*) \, &= \frac{P(l,a^*,e^*)}{P(a^*,e^*)} \onslide<7->{= \, P(l|a^*)\, }&&
\end{flalign*}
\end{textblock}
}

\only<8>{
\begin{textblock}{30}(60,70)
\centering \footnotesize
que llamen dado \\  que entraron y \\ sonó la alarma
\end{textblock}
}

\only<8>{
\begin{textblock}{30}(110,70)
\centering \footnotesize
que llamen dado \\  que sonó la alarma
\end{textblock}
}
...
\begin{textblock}{160}(0,4)
 \centering \Large
 $P(t|a) \only<-9>{\overset{?}{=}}\only<10>{\overset{\phantom{?}}{=}} P(t|a,l) $
\end{textblock}

\only<1->{
\begin{textblock}{40}(0,12)
\centering
  \scalebox{.6}{
\tikz{ %
        ...
        \node[factor] (fa) {} ;
        \node[det, fill=black!15, below=of fa, minimum size=0.55cm, yshift=0.6cm] (a) {$a$} ; %
        
        \node[factor, below=of a, yshift=0.6cm] (fl) {} ;
        \node[det, below=of fl, minimum size=0.55cm,yshift=0.6cm] (l) {$l$} ; %
        
        \node[det, above=of fa, minimum size=0.55cm, xshift=-0.8cm, yshift=-0.6cm] (e) {$e$} ; %
        \node[factor, above=of e, yshift=-0.6cm] (fe) {} ;
...
\only<2->{
\begin{textblock}{100}(50,18)
 $m_{f_a\rightarrow t}(t) = \sum_e P(e)P(a^*|e,t) $  \\[0.1cm]
 \end{textblock}
}

\only<3->{
\begin{textblock}{80}(45,23)
\begin{align*}
P(t|a^*) = \frac{\sum_e P(e)P(t)P(a^*|e,t)}{P(a^*)}  
\end{align*}
\end{textblock}
}
...
\tikz{ %
        ...
        \node[factor, below=of a, yshift=0.6cm] (fl) {} ;
        \node[det, fill=black!15, below=of fl, minimum size=0.55cm,yshift=0.6cm] (l) {$l$} ; %
...
\only<4->{
\begin{textblock}{100}(50,46)
 $m_{f_a\rightarrow a}\phantom{(a)} = P(a^*) \ \ \ \ \ \ \ \ \onslide<5->{P(a^*,l^*) = P(a^*)}\only<5-8>{P(l^*|a^*)}\only<9->{\cancel{P(l^*|a^*)}} $  \\[0.1cm]
 $m_{f_l\rightarrow a}\phantom{(a)} = P(l|a^*) $  \\[0.1cm]
 \onslide<6->{$m_{f_a\rightarrow t}(t) = \sum_e P(e)P(a^*|e,t) P(l^*|a^*) $}  \\[0.1cm]
 \end{textblock}
}

\only<7->{
\begin{textblock}{100}(55,70)
$   P(t,a^*,l^*) = \sum_e P(e)P(t)P(a^*|e,t) \only<-8>{P(l^*|a^*)}\only<9->{\cancel{P(l^*|a^*)}} $ \\[0.3cm]
$ \onslide<8->{P(t|a^*,l^*) =  \frac{P(t,a^*,l^*)}{P(a*,l^*)} } \onslide<9->{ = \frac{\sum_e P(e)P(t)P(a^*|e,t)}{P(a^*)}} \onslide<10>{= P(t|a^*) }$ 
\end{textblock}
}
...
\tikz{ %
        ...
        \node[factor] (fa) {} ;
        \node[det, below=of fa, minimum size=0.55cm, yshift=0.6cm] (a) {$a$} ; %
...
\begin{textblock}{100}(50,22)
 \onslide<2->{$m_{f_l\rightarrow a}(a) = P(l^*|a) $}  \\[0.1cm]
 \onslide<3->{$m_{f_a\rightarrow t}(t) =  \sum_{ea} P(e)P(a|e,t)P(l^*|a) $}
 \end{textblock}

\begin{textblock}{80}(60,40)
\onslide<4->{$P(t,l^*) = \sum_{ea} P(e)P(t)P(a|e,t)P(l^*|a)$} \\[0.3cm]
\onslide<5->{$P(t|l^*) = \frac{P(t,l^*)}{P(l^*)} \overset{?}{=} P(t) $}
\end{textblock}

\only<6->{
\begin{textblock}{30}(53,57)
\centering \footnotesize
un terremoto \\ dado que llamaron
\end{textblock}
}

\only<6->{
\begin{textblock}{30}(83,57)
\centering \footnotesize
un terremoto
\end{textblock}
}

\begin{textblock}{80}(60,75)
\onslide<7->{$P(t=1|l=1) \approx 0.27 \neq P(t=1)$}
\end{textblock}
...
\begin{textblock}{160}(0,4)
 \centering \Large
 $P(r) \overset{?}{=} P(r|a)  \ \ \ \ \ \ \ P(r|t) \overset{?}{=} P(r|t,a)$
\end{textblock}
...
\begin{textblock}{100}(50,22)
 \onslide<2->{$m_{f_a\rightarrow t}(t) =  \sum_e P(e)P(a^*|e,t) $}  \\[0.1cm]
 $\onslide<3->{m_{f_r\rightarrow r}(r) =  \sum_{et} P(e)P(t)P(a^*|e,t)P(r|t) } \onslide<4->{= P(r,a^*)} $
 \end{textblock}

\begin{textblock}{80}(60,36)
\onslide<5->{$P(r|a) = \frac{P(r,a^*)}{P(a^*)} \only<5-6>{\overset{?}{=}} \only<7->{\neq} P(r) \phantom{\overset{?}{=}} $}
\end{textblock}

\only<6>{
\begin{textblock}{30}(50,45)
\centering \footnotesize
que hablen del sismo \\ dada la alarma
\end{textblock}
}

\only<6>{
\begin{textblock}{30}(84,45)
\centering \footnotesize
que hablen del sismo
\end{textblock}
}

\only<8->{
\begin{textblock}{40}(0,52)
\centering
  \scalebox{.6}{
\tikz{ %
        ...
        \node[det, fill=black!15, minimum size=0.55cm, above=of fa, xshift=0.8cm, yshift=-0.6cm] (t) {$t$} ; %
        \node[factor, above=of t, yshift=-0.6cm] (ft) {} ;
        \node[factor, below=of t, xshift=0.8cm, yshift=0.6cm] (fr) {} ;
        \node[det,minimum size=0.55cm, below=of fr, yshift=0.6cm] (r) {$r$} ; %
...
\only<9->{
\begin{textblock}{120}(45,52)
 $\onslide<9->{P(t^*,a^*) =  \sum_e P(e)P(t^*)P(a^*|e,t^*)}$ \\[0.1cm]
 $\onslide<10->{m_{f_r\rightarrow r}(r) =}  \only<10>{\sum_e P(e)P(t^*)P(a^*|e,t^*)P(r|t^*)} \only<11->{P(t^*,a^*) P(r|t^*)} \only<12->{= P(r,t^*,a^*)}$ \\[0.1cm]
 \end{textblock}
}

\only<13->{
\begin{textblock}{80}(60,70)
$P(r|t^*,a^*) = \frac{\only<13>{P(r,t^*,a^*)}\only<14->{P(t^*,a^*) P(r|t^*)}}{P(t^*,a^*)} \only<15>{= P(r|t^*)}$
\end{textblock}
}
...
\begin{textblock}{100}(50,22)
 \onslide<2->{$m_{f_a\rightarrow t}(t) =  \sum_e P(e)P(a^*|e,t) $}  \\[0.1cm]
 $\onslide<3->{P(t|a^*) = \frac{P(t,a^*)}{P(a^*)} } \onslide<4->{ = \frac{1}{P(a^*)} \sum_{e} P(e)P(t)P(a^*|e,t)}$ \\[0.1cm]
 \end{textblock}
...
\tikz{ %
        ...
        \node[det, fill=black!15, above=of fa, minimum size=0.55cm, xshift=-0.8cm, yshift=-0.6cm] (e) {$e$} ; %
        \node[factor, above=of e, yshift=-0.6cm] (fe) {} ;
...
\only<6->{
\begin{textblock}{120}(45,52)
 $\onslide<6->{m_{f_a\rightarrow t}(t) =  P(e^*)P(a^*|e^*,t)}$ \\[0.1cm]
 $\onslide<7->{P(t|e^*,a^*) = \frac{P(t,e^*,a^*)}{P(e^*,a^*)}} \onslide<8->{= \frac{1}{P(e^*,a^*)} P(e^*)P(t)P(a^*|e^*,t) } $ \\[0.1cm]
 $\onslide<9->{m_{f_a\rightarrow a}\phantom{(a)} = \sum_t P(e^*)P(t)P(a^*|e^*,t)} \onslide<10->{ = P(e^*,a^*)} $
 \end{textblock}
}

\only<11->{
\begin{textblock}{80}(60,38)
$P(t=1|a=1) \approx 0.42$
\end{textblock}
}

\only<12->{
\begin{textblock}{80}(60,75)
$P(t=1|e=1,a=1) \approx 0.008$
\end{textblock}
}
...
\begin{textblock}{100}(50,22)
 \onslide<2->{$m_{f_a\rightarrow t}(t) =  \sum_{ea} P(e)P(a|e,t) P(l^*|a) $}  \\[0.1cm]
 $\onslide<3->{P(t|l^*) = \frac{P(t,l^*)}{P(l^*)} } \onslide<4->{ = \frac{1}{P(l^*)} \sum_{ea} P(e)P(t)P(a|e,t) P(l^*|a)}$
 \end{textblock}
...
\only<7->{
\begin{textblock}{120}(45,52)
 $\onslide<7->{m_{f_a\rightarrow t}(t) =  \sum_a P(e^*)P(a|e^*,t) P(l^*|a)}$ \\[0.1cm]
 $\onslide<8->{P(t|e^*,a^*) = \frac{P(t,e^*,l^*)}{P(e^*,l^*)}} \onslide<9->{= \frac{1}{P(e^*,l^*)} \sum_a P(e^*)P(t)P(a|e^*,t) P(l^*|a)} $ \\[0.1cm]
 $ \only<10>{m_{f_a\rightarrow a}(a) = \sum_{ta} P(e^*)P(t)P(a|e^*,t)} \only<11->{m_{f_{\,l\,}\rightarrow l\,}\phantom{(a)} =  \sum_{ta} P(e^*)P(t)P(a|e^*,t)P(l^*|a)} \only<12->{= P(e^*, l^*)} $
 \end{textblock}
}

\only<5->{
\begin{textblock}{80}(60,38)
$P(t=1|l=1) \approx 0.27$
\end{textblock}
}

\only<13->{
\begin{textblock}{80}(60,75)
$P(t=1|e=1,l=1) \approx 0.008$
\end{textblock}
}
...
\centering
 ...
 \centering
 Flujo de inferencia $\equiv$ correlación $\equiv$ no-independencia
 \end{textblock}
}
