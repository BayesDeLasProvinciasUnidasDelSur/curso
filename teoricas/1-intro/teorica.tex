...
\only<12>{ 
\begin{textblock}{80}(80,20)\centering
\tikz{
\node[latent, draw=white] (i) {$1$};
\node[latent, below=of i, fill=black, yshift=0.6cm,minimum size=2pt] (b0) {};
...
% & $x_1$ & $x_2$ & $x_3$ & \\ \hline
% $y_1$ & $\frac{1}{3}\frac{1}{1}$ & & & \onslide<19->{$\frac{1}{3}$} \\ \hline
% $y_2$ & & $\frac{1}{3}\frac{1}{2}$ & & \onslide<19->{$\frac{1}{6}$} \\ \hline
% $y_3$ & & $\frac{1}{3}\frac{1}{2}$ & & \onslide<19->{$\frac{1}{6}$} \\ \hline
% $y_4$ & & & $\frac{1}{3}\frac{1}{1}$ & \onslide<19->{$\frac{1}{3}$} \\ \hline \hline
% & \onslide<19->{$\frac{1}{3}$} & \onslide<19->{$\frac{1}{3}$} & \onslide<19->{$\frac{1}{3}$} & \only<20>{$1$} \\ \hline
% \end{tabular}
% }
...
\begin{center}
 {\normalsize Regla 2 } \\ 
 Sumar las creencias parciales \\ en partes iguales
 \end{center} 
