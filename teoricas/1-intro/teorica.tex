...
\begin{textblock}{160}(0,4)
 \centering \LARGE
 Exploradores erupeos perdidos
 \end{textblock}
\vspace{1cm}
 \centering
 \includegraphics[width=0.7\textwidth]{../../aux/static/naufrago.jpg}  
...
\begin{frame}[plain]
\begin{textblock}{155}(0,4)
 \centering \LARGE 
 \en{The cultural hypotesis}
 \es{La hipótesis cultural}
\end{textblock}
...
\begin{center}
 \LARGE 
 \en{\textbf{Maximum uncertainty \\ given the available states}}
 \es{\textbf{Máxima incertidumbre \\ dado los estados disponibles}}
\end{center}
