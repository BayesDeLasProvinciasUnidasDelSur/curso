...
\tikz{ %
         ...
         \node[det, minimum size=1cm] (p1) {\includegraphics[width=0.065\textwidth]{montyHall_13}} ;
         \node[det, minimum size=1cm, xshift=1.5cm] (p2) {\includegraphics[width=0.065\textwidth]{montyHall_12}} ;
         \node[det, minimum size=1cm, xshift=3cm] (p3) {\includegraphics[width=0.065\textwidth]{montyHall_13}} ;
%         
%         
