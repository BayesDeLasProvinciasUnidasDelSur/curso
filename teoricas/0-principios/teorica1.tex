...
\begin{textblock}{160}(0,4)
 ...
 \begin{textblock}{160}(0,32)
\centering
\only<2>{\includegraphics[page=5,width=0.49\textwidth]{figuras/posterior_win} 
}
\end{textblock}

\begin{textblock}{160}(0,32)
\centering
\only<3>{\includegraphics[page=6,width=0.49\textwidth]{figuras/posterior_win} 
}
\end{textblock}

\begin{textblock}{160}(0,32)
\centering
\only<4>{\includegraphics[width=0.49\textwidth]{figuras/posterior_lose} 
}
\end{textblock}
