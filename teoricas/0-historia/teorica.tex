...
\begin{frame}[plain]
 \begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{Agricultura $\mapsto$ Población $\mapsto$ Centros de innovación }
 \end{textblock} 
...
\begin{frame}[plain]
 \begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{China}
 \end{textblock} 



\begin{textblock}{80}(0,12)
  \Large \centering \textcolor{black!75}{}
\end{textblock} 
...
\begin{textblock}{160}(0,4)
\centering \LARGE  \textcolor{black!75}{Polinesia - América}
\end{textblock}
...
\begin{frame}[plain]
\begin{textblock}{160}(0,4)
\centering \LARGE  \textcolor{black!75}{Involución cultural por aislamiento} \\
\Large Tasmania
\end{textblock}
...
\begin{textblock}{80}(0,26)
  \centering 
\includegraphics[width=0.5\textwidth]{../../auxiliar/static/malleus}  
  \end{textblock} 

\centering
\begin{textblock}{80}(70,30)
  \centering 
\includegraphics[width=0.9\textwidth]{../../auxiliar/static/naufrago}  
  \end{textblock} 
...
\begin{frame}[plain]
\begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{La pandemia y la plata}
 \end{textblock} 
\vspace{1cm}
...
\begin{frame}[plain]
\begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{El Narco-Estado Británico}
 \end{textblock} 
\vspace{1cm}

\centering

\includegraphics[width=0.45\textwidth]{../../auxiliar/static/opium-war.jpg}  
 
\end{frame}

\begin{frame}[plain]
\begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{La guerra contra el narcotráfico}
 \end{textblock}  
\vspace{1cm}
 \centering
\includegraphics[width=0.85\textwidth]{figures/china.pdf}
\end{frame} 

\begin{frame}[plain]
\begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{La era eurocéntrica}
 \end{textblock} 
...
\begin{frame}[plain]
\begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{Era de los genocidios y pérdida cultural}
 \end{textblock} 
...
\begin{frame}[plain]
\begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{La crisis ecológica actual}
 \end{textblock} 
...
\begin{frame}[plain]
\begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!75}{Ecological adaptation arise in local communities}
 \end{textblock} % Evolution of Institutions for Collective Action
\vspace{1.1cm}

\centering
 \includegraphics[width=0.8\textwidth]{../../auxiliar/static/bali-channel} 
