...
\scalebox{1}{
 \tikz{        
    \node[latent] (d) {\includegraphics[width=0.1\textwidth]{../../aux/static/dedo.png}} ;
    \node[const,above=of d] (nd) {\Large $s$} ;
    \node[latent, above=of d, xshift=-1.5cm] (r) {\includegraphics[width=0.12\textwidth]{../../aux/static/regalo.png}} ;
    \node[const,above=of r] (nr) {\Large $r$} ;
    \node[latent, fill=black!30, above=of d, xshift=1.5cm] (c) {\includegraphics[width=0.12\textwidth]{../../aux/static/cerradura.png}} ;
...
\tikz{
         \node[factor, minimum size=1cm] (p1) {\includegraphics[width=0.05\textwidth]{../../aux/static/cerradura.png}} ;
         \node[det, minimum size=1cm, xshift=1.5cm] (p2) {\includegraphics[width=0.06\textwidth]{../../aux/static/dedo.png}} ;
