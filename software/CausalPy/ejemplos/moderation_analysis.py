...
Original file is located at
    https://colab.research.google.com/github/pymc-devs/pymc-examples/blob/main/examples/causal_inference/moderation_analysis.ipynb
...
![](https://github.com/pymc-devs/pymc-examples/blob/main/examples/causal_inference/moderation_figure.png?raw=1)
