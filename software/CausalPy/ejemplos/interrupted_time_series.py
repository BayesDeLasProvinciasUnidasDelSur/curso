...
Original file is located at
    https://colab.research.google.com/github/pymc-devs/pymc-examples/blob/main/examples/causal_inference/interrupted_time_series.ipynb
...
![](https://github.com/pymc-devs/pymc-examples/blob/main/examples/causal_inference/DAG_interrupted_time_series.png?raw=1)
