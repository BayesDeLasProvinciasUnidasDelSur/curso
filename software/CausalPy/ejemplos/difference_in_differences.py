...
Original file is located at
    https://colab.research.google.com/github/pymc-devs/pymc-examples/blob/main/examples/causal_inference/difference_in_differences.ipynb
...
![](https://github.com/pymc-devs/pymc-examples/blob/main/examples/causal_inference/DAG_difference_in_differences.png?raw=1)
