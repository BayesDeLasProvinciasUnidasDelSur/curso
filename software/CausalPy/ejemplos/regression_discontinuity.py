...
Original file is located at
    https://colab.research.google.com/github/pymc-devs/pymc-examples/blob/main/examples/causal_inference/regression_discontinuity.ipynb
...
![regression discontinuity design schematic](https://github.com/pymc-devs/pymc-examples/blob/main/examples/causal_inference/regression_discontinuity.png?raw=1)
