...
Original file is located at
    https://colab.research.google.com/github/pymc-devs/pymc-examples/blob/main/examples/causal_inference/interventional_distribution.ipynb
...
![](https://github.com/pymc-devs/pymc-examples/blob/main/examples/causal_inference/sprinkler.png?raw=1)
