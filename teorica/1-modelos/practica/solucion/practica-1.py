...
pDatosM012=[np.cumprod(pDatosNoMontyHall_M0)[0:100]*1/3,
            np.cumprod(pDatosNoMontyHall_M1)[0:100]*1/3,
            np.cumprod(pDatosNoMontyHall_M2)[0:100]*1/3]
...
with open("datos/NoMontyHall.csv", mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['c', 's', 'r'])  # Write the header
    writer.writerows(DatosNoMontyHall)  # Write the data rows
#t=t+1
