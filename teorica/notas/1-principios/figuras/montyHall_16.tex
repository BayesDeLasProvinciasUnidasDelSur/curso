...
\tikz{ %
         ...
         \node[det, minimum size=1cm] (p1) {\includegraphics[width=0.065\textwidth]{montyHall_14}} ;
         \node[det, minimum size=1cm, xshift=1.5cm] (p2) {\includegraphics[width=0.065\textwidth]{montyHall_15}} ;
         \node[det, minimum size=1cm, xshift=3cm] (p3) {\includegraphics[width=0.065\textwidth]{montyHall_14}} ;
%         
%         
         \node[const, above=of p1, yshift=.15cm] (fp1) {$1/3$};
         \node[const, above=of p2, yshift=.15cm] (fp2) {$1/6$};
