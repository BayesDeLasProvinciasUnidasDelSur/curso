...
% 
% \begin{textblock}{45}(08,79)
% \includegraphics[width=1\textwidth]{../../auxiliar/static/utt}
% %\textcolor{black!15}{\Large Laboratorio Pacha Pampas \\ \small Bayes de las Provincias Unidas del Sur}
% \end{textblock}

% 
% \begin{textblock}{60}(50,66)
% \textcolor{black!20}{\rotatebox[origin=tr]{-0}{\scalebox{2.5}{\bet}}}
% \end{textblock}
% \begin{textblock}{60}(50,66)
% \textcolor{black!20}{\rotatebox[origin=tr]{3}{\scalebox{2.5}{$p$}}}
% \end{textblock}
